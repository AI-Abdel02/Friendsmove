...
export const metadata: Metadata = {
  title: "Umzug Viernheim – Umzugsunternehmen Viernheim | FriendsMove",
  description:
    "Professionelles Umzugsunternehmen in Viernheim. Privatumzug, Firmenumzug – vollversichert, Festpreis, Antwort in 60 Minuten. Jetzt kostenlos anfragen.",
  alternates: { canonical: "https://www.friendsmove.de/regionen/viernheim" },
};

export default function ViernheimPage() {
  const schema = cityBusinessSchema("Viernheim", "viernheim");
  return (
    <>
          ...
          <div>
            <nav aria-label="Breadcrumb" className="mb-6">
              <ol className="flex items-center gap-2 text-sm text-white/40">
                ...
                <li aria-hidden="true">/</li>
                <li className="text-white/70">Viernheim</li>
              </ol>
            </nav>
            <span className="text-5xl mb-4 block" aria-hidden="true">🛍</span>
            <p className="section-label text-brand-green">Umzug Viernheim</p>
            <h1 id="city-heading" className="font-display font-bold text-4xl md:text-5xl text-white mt-2 mb-5 leading-tight">
              ...
              <span className="text-brand-green">in Viernheim</span>
            </h1>
            <p className="text-white/70 text-lg leading-relaxed mb-6 max-w-lg">
              FriendsMove ist Ihr lokaler Umzugspartner in Viernheim – Einkaufsstadt an der Bergstraße. 
            ...
            <p className="text-white/50 text-sm mb-8 p-4 bg-white/5 rounded-xl border border-white/10">
              ...
              wachsende Wohngebiete, gute Autobahnnähe
            </p>
      ...
      <SectionWrapper className="bg-brand-bg">
        <div className="text-center mb-10">
          <p className="section-label">Unsere Services in Viernheim</p>
          <h2 className="font-display font-bold text-3xl text-brand-dark mb-4">Was wir in Viernheim anbieten</h2>
        </div>
