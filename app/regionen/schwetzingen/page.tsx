...
export const metadata: Metadata = {
  ...
  description:
    "Professionelles Umzugsunternehmen in Schwetzingen. Privatumzug, Firmenumzug – vollversichert, Festpreis, Antwort in 60 Minuten. Jetzt kostenlos anfragen.",
  alternates: { canonical: "https://www.friendsmove.de/regionen/schwetzingen" },
};

export default function SchwetzingenPage() {
        ...
        <div className="container-max relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <p className="text-white/70 text-lg leading-relaxed mb-6 max-w-lg">
              FriendsMove ist Ihr lokaler Umzugspartner in Schwetzingen – Schlossstadt in der Kurpfalz. 
