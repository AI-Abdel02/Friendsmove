...
export const metadata: Metadata = {
  ...
  description:
    "Professionelles Umzugsunternehmen in Ludwigshafen. Privatumzug, Firmenumzug – vollversichert, Festpreis, Antwort in 60 Minuten. Jetzt kostenlos anfragen.",
  alternates: { canonical: "https://www.friendsmove.de/regionen/ludwigshafen" },
};
        ...
        <div className="container-max relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <p className="text-white/70 text-lg leading-relaxed mb-6 max-w-lg">
              FriendsMove ist Ihr lokaler Umzugspartner in Ludwigshafen – Industriestadt am Rhein. 
            ...
            <p className="text-white/50 text-sm mb-8 p-4 bg-white/5 rounded-xl border border-white/10">
              ...
              Industrie- und Wohnmix, Rheinbrücken, Gewerbelogistik
            </p>
