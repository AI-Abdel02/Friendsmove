...
export const metadata: Metadata = {
  ...
  description:
    "Professionelles Umzugsunternehmen in Weinheim. Privatumzug, Firmenumzug – vollversichert, Festpreis, Antwort in 60 Minuten. Jetzt kostenlos anfragen.",
  alternates: { canonical: "https://www.friendsmove.de/regionen/weinheim" },
};

export default function WeinheimPage() {
        ...
        <div className="container-max relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <p className="text-white/70 text-lg leading-relaxed mb-6 max-w-lg">
              FriendsMove ist Ihr lokaler Umzugspartner in Weinheim – Zwei-Burgen-Stadt. 
            ...
            <p className="text-white/50 text-sm mb-8 p-4 bg-white/5 rounded-xl border border-white/10">
              ...
              Hanglage im Altstadt-Bereich, kurvenreiche Zufahrten
            </p>
